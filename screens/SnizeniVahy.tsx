  ...
  return (
    <Layout>
       ...
       <TouchableOpacity onPress={()=>{setSwitchStudy(!switchStudy)}}>
            {!switchStudy&&<Image source={require("../assets/bez_vahy.png")} resizeMode="contain" style={{width:w<1180?700:720, height:w<1180?750:800}}/>}
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>{setSwitchStudy(!switchStudy)}}>
            {switchStudy&&<Image source={require("../assets/bez_vahy_2.png")} resizeMode="contain" style={{width:w<1180?700:720, height:w<1180?750:800}}/>}
        </TouchableOpacity>
